    ...
    return (
      ...
      <div className="container" style={ {backgroundColor: "beige", borderStyle: "solid", borderWidth: "1px"} }>
        ...
        <div className="page-header">
          ...
          <h2 className="text-center" style={ {marginTop: "-12px"} }><b><i>DIY Network</i></b></h2>
          <h4 className="text-center">Search for and DIY articles of interest. Click on headlines to learn more.</h4>
        </div>
